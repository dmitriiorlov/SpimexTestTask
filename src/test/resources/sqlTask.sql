...
-- 2. Отсориторовать данные по дате в обратном порядке
-- 2. Вывести данные только по Joanna
-- 3. Вывести данные только по Joanna за период [март-сентябрь] 2017 года
-- 4. Подсчитать сколько получила Joanna за период [март-сентябрь] 2017 года
-- 5. Вывести сколько раз Joanna получала одинаковую сумму в формате [amount | кол-во раз], например:
--                                                                                                   5000   | 3
--                                                                                                   10000  | 1 ...
